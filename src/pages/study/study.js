...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const studyEndWrap = document.querySelector("[data-study-end-wrap]");
    ...
    const showQuiz = [...quizArr].sort(() => Math.random() - 0.5).slice(0, 5); // 이렇게 변경하면 원본은 유지한채로 새로운 배열[...quizArr]을 만들어 랜덤하게 섞고 5문제를 추출함 -> 얕은 복사
    ...
    const progressState = Array(showQuiz.length).fill(null);
    // DOM 요소 가져오기
