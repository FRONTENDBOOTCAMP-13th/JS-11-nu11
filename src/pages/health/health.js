...
function addHealthExp() {
    const currentExp = parseInt(localStorage.getItem("exPoint") || "0") || 0;
    const newExp = currentExp + healthExp;
...
function spacebarEvent() {
    // 변수 정리
    const gaugeFill = document.querySelector("#sprintGauge");
    const spacebar2D = document.querySelector("#spacebar2d");
    const spacebar3D = document.querySelector("#spacebar3d");
    const character = document.querySelector("#character");
    const celebrateImg = document.querySelector("#celebrate");
    const gaugeContainer = document.querySelector("#gauage-container");
...
spacebarEvent();
const healthWrap = document.querySelector("[data-health-wrap]");
